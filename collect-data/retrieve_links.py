...
for i, k in wikt_dict.items():
	file.write(str(i) + " : " + str(k))
	file.write("\n")

>>> dic = {"ένα": "Γιάννης", "δύο": "Έλενα", "τρία": "Άννα", "τέσσερα": "Αλεξία"}
>>> dic
{'ένα': 'Γιάννης', 'δύο': 'Έλενα', 'τρία': 'Άννα', 'τέσσερα': 'Αλεξία'}
>>> list(dic)
['ένα', 'δύο', 'τρία', 'τέσσερα']
>>> sorted(dic)
['ένα', 'δύο', 'τέσσερα', 'τρία']
>>> sorted(dic.values())
['Άννα', 'Έλενα', 'Αλεξία', 'Γιάννης']
>>> dic
{'ένα': 'Γιάννης', 'δύο': 'Έλενα', 'τρία': 'Άννα', 'τέσσερα': 'Αλεξία'}
>>> k = sorted(dic.values())
>>> k
['Άννα', 'Έλενα', 'Αλεξία', 'Γιάννης']
>>> sorted_d = [(k,v) for k,v in dic.items()]
>>> sorted_d
[('ένα', 'Γιάννης'), ('δύο', 'Έλενα'), ('τρία', 'Άννα'), ('τέσσερα', 'Αλεξία')]
>>> dict(sorted(dic.items()))
{'ένα': 'Γιάννης', 'δύο': 'Έλενα', 'τέσσερα': 'Αλεξία', 'τρία': 'Άννα'}
